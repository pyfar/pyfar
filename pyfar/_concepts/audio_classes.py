...
equidistant and complete audio data that can be converted between the time and
frequency domain by means of the
:py:mod:`Fourier transform <pyfar.dsp.fft_concepts>`.
